<div class="sidebar-widget product-tag wow fadeInUp">
  ...
  <div class="sidebar-widget-body outer-top-xs">
    <div class="tag-list"> <a class="item" title="Anak-anak"  href="{{ url('login') }}">Anak-anak</a> <a class="item" title="Remaja"  href="{{ url('login') }}">Remaja</a> <a class="item" title="Dewasa"  href="{{ url('login') }}">Dewasa</a></div>
  </div>
</div>
