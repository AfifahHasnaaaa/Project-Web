...
@section('script_custom')
    <script>
            ...
            $.ajax(link, {
                ...
                success: function(data, status, xhr) {
                    ...
                    $.each(objData, function(key, value) {
                        ...
                        dataTable += '<td><a href="' + url_edit +
                            '" class="btn btn-info">Ubah</a> <a href="#" ' + eventHapus +
        ...
        function resetTable() {
            $("#data-list").html(
                "<thead> <tr> <th>No.</th> <th>Kode</th> <th>Nama</th> <th>Stok</th> <th>Harga</th> <th>Deskripsi</th> <th>Gambar</th> <th>OPSI</th> </tr> </thead>"
                );
        }
    </script>
