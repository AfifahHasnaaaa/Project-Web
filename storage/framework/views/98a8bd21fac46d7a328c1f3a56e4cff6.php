<div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
    <div class="more-info-tab clearfix ">
      ...
      <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
        ...
        <li><a data-transition-type="backSlide" href="#smartphone" data-toggle="tab">Anak-anak</a></li>
        <li><a data-transition-type="backSlide" href="#laptop" data-toggle="tab">Remaja</a></li>
        <li><a data-transition-type="backSlide" href="#apple" data-toggle="tab">Dewasa</a></li>
      </ul>
    </div>
  ...
  </div><?php /**PATH C:\DATAKU\Hodieku\resources\views/template/additional/new_product.blade.php ENDPATH**/ ?>