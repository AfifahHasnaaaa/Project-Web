...
<form id="formData"  enctype="multipart/form-data" method="POST" action="<?php echo e(url('produk')); ?>">
    <?php echo csrf_field(); ?>
	<table>
		<tr>
			<td>Kode Produk</td>
...
<?php echo $__env->make('template/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\22.02.0803\Responsi\cart_22.02.0803_Afifah\resources\views/produk/form.blade.php ENDPATH**/ ?>