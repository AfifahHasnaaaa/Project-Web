...
<script>
        function hapusData(idProduk) {
            var url_post = '<?php echo e(url("api/produk/hapus")); ?>';
        ...
        function add_to_cart(idProduk) {
            var url_post = '<?php echo e(url("api/keranjang")); ?>';
            ...
            $.ajax(link, {
                ...
                success : function (data, status, xhr) {
                    ...
                    $.each( objData, function( key, value ) {
                        var url_edit = '<?php echo e(url("produk/form")); ?>' + '/' + value.id_produk;
...
<script type="text/javascript">
	var url = '<?php echo e(url("api/produk/dataTable")); ?>';
...
<?php echo $__env->make('template/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\22.02.0803\Responsi\cart_22.02.0803_Afifah\resources\views/produk/list.blade.php ENDPATH**/ ?>