		...
		<div class="header-top-inner">
		  <div class="cnt-account">
			<ul class="list-unstyled">
			  ...
			  <li><a href="<?php echo e(url('keranjang')); ?>"><i class="icon fa fa-shopping-cart"></i>My Cart</a></li>
			...
			<div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
			  <div class="nav-outer">
				<ul class="nav navbar-nav">
				  ...
				  <li class="dropdown yamm-fw"> <a href="<?php echo e(url('produk/form')); ?>" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Produk</a> </li>
				  ...
				  <li class="active dropdown yamm-fw"> <a href="<?php echo e(url('transaksi')); ?>" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Transaksi</a> </li>
				  <li class="dropdown yamm-fw"> <a href="<?php echo e(url('laporan')); ?>" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Laporan</a> </li>
...
<?php /**PATH C:\DATAKU\Hodieku\resources\views/template/user/page_header_user.blade.php ENDPATH**/ ?>